#ifndef DMP9_ROM_ADDRS_XN349F0_H
#define DMP9_ROM_ADDRS_XN349F0_H
/*
 * XN349F0 — Yamaha DMP9/DMP16 ROM v1.10 (1994-01-20)
 * Confirmed function and data addresses for Ghidra analysis scripts.
 *
 * NOTE: v1.10 differs from v1.11 by ~96 small patches (mostly branch-target
 * fixups). The init/library cluster (0x400–0x9FF, 0x238C, 0x23AE block) is
 * binary-identical across all 3 ROMs. MIDI / scene / hw_model addresses are
 * not yet confirmed for v1.10 — propagate via DMP9_VersionTrack.
 */

/* ── Reset / Init ─────────────────────────────────────────────── */
/* #define ADDR_reset_handler        0x???? */  /* TODO: not yet confirmed for v1.10 */
/* #define ADDR_hw_model_init        0x???? */  /* TODO: not yet confirmed for v1.10 */
/* #define ADDR_hw_model_detect      0x???? */  /* TODO: not yet confirmed for v1.10 */

/* ── LCD ──────────────────────────────────────────────────────── */
/* LCD init cluster — same offsets as v1.11 (init section, never relocated) */
...
/* ── MIDI ─────────────────────────────────────────────────────── */
/* #define ADDR_midi_tx_byte         0x???? */  /* TODO: not yet confirmed for v1.10 */
/* #define ADDR_midi_process_rx      0x???? */  /* TODO: not yet confirmed for v1.10 */

/* ── Scene ────────────────────────────────────────────────────── */
/* #define ADDR_scene_recall         0x???? */  /* TODO: not yet confirmed for v1.10 */
/* #define ADDR_scene_store          0x???? */  /* TODO: not yet confirmed for v1.10 */
...
/* ── Data addresses ───────────────────────────────────────────── */
/* #define DATA_model_params_dmp9    0x???? */  /* TODO: not yet confirmed for v1.10 */
/* #define DATA_model_params_dmp16   0x???? */  /* TODO: not yet confirmed for v1.10 */
/* #define DATA_dsp_display_s        0x???? */  /* TODO: not yet confirmed for v1.10 */

#endif /* DMP9_ROM_ADDRS_XN349F0_H */
